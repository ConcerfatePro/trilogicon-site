...
export function ArchitectureSection() {
  return (
    <SectionShell id="architecture">
      ...
      {/* Flow: horizontal on large screens, vertical rhythm on small */}
      <div className="relative">
        <div className="absolute left-4 top-0 hidden h-full w-px bg-zinc-800 md:left-1/2 md:block md:-translate-x-1/2" />
        <div className="grid gap-4 md:grid-cols-2 md:gap-x-12 md:gap-y-6">
          {architecture.modules.map((m, i) => (
            <motion.article
              ...
              className={`relative border border-zinc-800 bg-tril-surface p-5 md:p-6 ${
            ...
            >
              ...
              <h3 className="mt-2 font-mono text-sm font-medium text-zinc-100">{m.title}</h3>
      ...
      <motion.p
        ...
        viewport={{ once: true }}
        className="mt-12 rounded border border-zinc-800 bg-tril-elevated p-6 font-mono text-xs leading-relaxed text-zinc-500 md:text-sm"
      >
