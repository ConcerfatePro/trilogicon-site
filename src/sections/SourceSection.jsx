  ...
  return (
    <SectionShell id="source" className="bg-tril-surface/25">
      ...
      >
        ...
        <div className="mt-6 max-w-2xl space-y-4 text-base leading-relaxed text-zinc-400">
      ...
      <motion.div
        ...
        className="mt-12 border border-zinc-800 bg-tril-black/80 p-6 md:p-8"
      >
        <p className="font-mono text-xs uppercase tracking-widest text-zinc-500">{source.coreLabel}</p>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-zinc-500">{source.coreDescription}</p>
        <a
          href={source.coreUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="mt-6 inline-flex items-center gap-2 border border-zinc-700 bg-transparent px-5 py-3 font-mono text-xs font-medium uppercase tracking-widest text-zinc-200 transition-colors hover:border-zinc-500 hover:text-zinc-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2 focus-visible:ring-offset-tril-black"
        >
